                ...
                children: logs
                    .map(
                      (log) => Card(
                        ...
                        child: ListTile(
                          leading: Icon(
                            log.accessGranted ? Icons.check_circle : Icons.cancel,
                            color: log.accessGranted ? Colors.green : Colors.red,
                          ),
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              if (log.userId != null) Text('User: ${log.userId}'),
                    ...
                    .map(
                      (log) => Card(
                        ...
                        child: ListTile(
                          ...
                          title: Text('Tracking: ${log['trackingId'] ?? 'N/A'}'),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              if (log['userId'] != null)
